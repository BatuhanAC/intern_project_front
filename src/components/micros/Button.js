  ...
  return (
    <>
      <button
        ...
        ${location.pathname !== "/bmi" && "font-bold text-lg bg-white text-black shadow-md shadow-black p-1 rounded-xl hover:text-white text-center cursor-default self-center w-full disabled:bg-gray-500 disabled:opacity-25 hover:bg-black"}
        `}
