  ...
  return (
    <>
      <button
        ...
        ${location.pathname !== "/bmi" && "font-bold text-lg bg-white text-black shadow-md shadow-black p-1 w-max rounded-xl hover:text-white text-center cursor-default self-center w-[50%] disabled:bg-gray-500 disabled:opacity-25 hover:bg-black"}
        `}
