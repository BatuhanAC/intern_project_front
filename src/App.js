...
function App() {
  ...
  return (
    <div className="flex w-full h-full bg-slate-300 items-center justify-center">
      ...
      && "flex flex-col w-full bg-transparent items-center aspect-square justify-center z-0"}
      ${(location.pathname === "/diet" || location.pathname === "/progress" || location.pathname === "/photos" ) 
      && "flex flex-col min-w-[95%] min-h-[95%] bg-transparent items-center justify-center z-0"}
      `}>
